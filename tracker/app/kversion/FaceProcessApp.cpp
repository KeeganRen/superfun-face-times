...
void FaceProcessApp::startFaceForestTracker(){
    ...
    string ffd_config_file = "data/config_ffd.txt";
    string headpose_config_file = "data/config_headpose.txt";
    string face_cascade = "data/haarcascade_frontalface_alt.xml";
...
bool FaceProcessApp::processFace(){
	...
	vector<Face> faces;
    ff->analize_image( gray, faces );
	
	FaceForest::show_results(im, faces, 10);
